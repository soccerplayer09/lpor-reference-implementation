...
const BIBTEX = `@inproceedings{lpor2026,
  ...
  author    = {Kim, Donggoo and Upadhayaya, Rajesh and Bator, Milosz and Le, Tao},
    ...
    <div className="landing-academic">
      ...
      <header className="la-hero">
        ...
        <nav className="la-nav">
          <a href="https://arxiv.org/abs/2606.08211" className="la-btn la-btn-outline" target="_blank" rel="noopener noreferrer">📄 Paper</a>
          <a href="https://drive.google.com/file/d/1mZK4QVfQMNnv2oRu2mqVML0SKAtXB5Ah/view?usp=sharing" className="la-btn la-btn-outline" target="_blank" rel="noopener noreferrer">📊 Slides</a>
          <a href="https://github.com/soccerplayer09/lpor-reference-implementation" className="la-btn la-btn-outline" target="_blank" rel="noopener noreferrer">💻 GitHub</a>
      ...
      <section className="la-section la-section-alt">
        <div className="la-abstract-grid">
          <a href="https://arxiv.org/pdf/2606.08211" className="la-paper-preview" target="_blank" rel="noopener noreferrer">
